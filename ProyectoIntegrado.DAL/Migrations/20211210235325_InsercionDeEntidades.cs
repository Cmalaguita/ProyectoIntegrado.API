...
{
    public partial class InsercionDeEntidades : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FamiliasP", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4")
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ciclos_FamiliasP_IdFamilia",
                        column: x => x.IdFamilia,
                        principalTable: "FamiliasP",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ciclos_TipoCiclos_IdTipo",
                        column: x => x.IdTipo,
            ...
            migrationBuilder.CreateTable(
                name: "CicloPosicionDeTrabajo",
                columns: table => new
                {
                    CiclosId = table.Column<int>(type: "int", nullable: false),
                    PosicionesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CicloPosicionDeTrabajo", x => new { x.CiclosId, x.PosicionesId });
                    table.ForeignKey(
                        name: "FK_CicloPosicionDeTrabajo_Ciclos_CiclosId",
                        column: x => x.CiclosId,
                        principalTable: "Ciclos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CicloPosicionDeTrabajo_Posiciones_PosicionesId",
                        column: x => x.PosicionesId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstadoInscripcion = table.Column<string>(type: "longtext", nullable: true, collation: "utf8mb4_0900_ai_ci")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Inscripciones_Empresas_EmpresaId",
                        column: x => x.EmpresaId,
                        principalTable: "Empresas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Inscripciones_Posiciones_PosicionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CicloPosicionDeTrabajo_PosicionesId",
                table: "CicloPosicionDeTrabajo",
                column: "PosicionesId");

            migrationBuilder.CreateIndex(
                name: "IX_Ciclos_IdFamilia",
                table: "Ciclos",
                column: "IdFamilia");

            migrationBuilder.CreateIndex(
                name: "IX_Ciclos_IdTipo",
                table: "Ciclos",
                column: "IdTipo");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inscripciones_EmpresaId",
                table: "Inscripciones",
                column: "EmpresaId");

            migrationBuilder.CreateIndex(
                name: "IX_Inscripciones_PosicionId",
                table: "Inscripciones",
                column: "PosicionId");
