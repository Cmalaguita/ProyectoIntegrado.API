...
namespace ProyectoIntegrado.DAL.Entities
{
    public partial class proyectointegradodbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseMySql("server=localhost;port=3306;user=carlos;password=sargentomillo;database=proyectointegradodb", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.22-mysql"));
            }
        }
